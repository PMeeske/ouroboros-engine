...
public static class CollectiveMindFactory
{
    ...
    public static CollectiveMind CreateBalanced(ChatRuntimeSettings? settings = null)
    {
        ...
        mind.AddPathway("Ollama", ChatEndpointType.OllamaLocal, "qwen2.5-vl:7b", settings: settings);
    ...
    /// </summary>
    public static CollectiveMind CreateLocal(string model = "qwen2.5-vl:7b", string endpoint = DefaultEndpoints.Ollama, ChatRuntimeSettings? settings = null)
    {
        var mind = new CollectiveMind();
    ...
    public static CollectiveMind CreateLocalFirstDecomposed(
        string localModel = "qwen2.5-vl:7b",
