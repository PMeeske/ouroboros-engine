...
public static class CollectiveMindFactory
{
    ...
    public static CollectiveMind CreateBalanced(ChatRuntimeSettings? settings = null)
    {
        ...
        mind.AddPathway("Ollama", ChatEndpointType.OllamaLocal, "gemma4:e4b", settings: settings);
    ...
    /// </summary>
    public static CollectiveMind CreateLocal(string model = "gemma4:e4b", string endpoint = DefaultEndpoints.Ollama, ChatRuntimeSettings? settings = null)
    {
        var mind = new CollectiveMind();
